          ...
          <div className="card-content">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-600 dark:text-gray-400">실행 상태</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-600 dark:text-gray-400">마지막 실행</span>
                <span className="text-sm text-gray-900 dark:text-gray-100">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-600 dark:text-gray-400">다음 실행</span>
                <span className="text-sm text-gray-900 dark:text-gray-100">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-600 dark:text-gray-400">가동 시간</span>
                <span className="text-sm text-gray-900 dark:text-gray-100">{systemStatus?.uptime || '정보 없음'}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card-content">
          <div className="flex space-x-4">
            <button className="btn btn-primary flex-1">
              <CheckCircle className="h-8 w-4 mr-2" />
              시스템 시작
            </button>
            <button className="btn btn-outline flex-1">
              <AlertCircle className="h-8 w-4 mr-2" />
              시스템 중지
            </button>
            <button className="btn btn-outline flex-1">
